...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--multi_G', type=bool, default=False, help='use multi generators')
        parser.add_argument('--model_M', type=bool, default=False, help='if need Mapping network')
        ...
        parser.add_argument('--G_norm', type=str, default='instance', help='G instance normalization or batch normalization [instance | batch | none]')
        parser.add_argument('--D_norm', type=str, default='instance', help='D instance normalization or batch normalization [instance | batch | none]')
        ...
        parser.add_argument('--with_mask', type=bool, default=True, help='if with mask')
