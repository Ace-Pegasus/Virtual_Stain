...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_classes', type=int, default=2, help='number of classes (background as a class)')
    ...
    model_save_path = './nucleus_saved_models'
    ...
    save_fr = 50
    print_freq = 1  # make sure that print_freq is smaller than len(dataset) & len(dataset_test)
    ...
    for epoch in range(num_epochs):
        ...
        if epoch%save_fr == 0:
            torch.save(model.state_dict(), f'{model_save_path}/mask_rcnn_model_epoch_{epoch:05d}.pt')
